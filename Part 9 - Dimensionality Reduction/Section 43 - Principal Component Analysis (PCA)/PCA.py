...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 14 00:55:33 2018
...
explained_variance=pca.explained_variance_ratio_ #Et on choisit le n_components(d'abord None) tq on explique le max de variance (au moins 50%)
